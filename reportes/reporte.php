...
$query1 = "SELECT id_serial, codigo_producto, nombre_producto, marca_producto, modelo_producto, numero_bien, condicion_producto, responsable_entrega, asignacion_producto
 FROM funcionario f 
