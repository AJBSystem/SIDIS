<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Serial vacío";          
		...
		} else if (empty($_POST['mod_codigo_inventario'])){
			...
			!empty($_POST['mod_codigo_inventario']) &&
		...
		$codigo_inventario=mysqli_real_escape_string($con,(strip_tags($_POST["mod_codigo_inventario"],ENT_QUOTES)));
