			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><a href="pdf/reporte_reasignacion.php?id_producto=<?php echo $row ['id_producto']?>"><button type='button' class='btn btn-default btn-primary' title="Reporte Individual por producto "><span class='glyphicon glyphicon-print' aria-hidden='true' value='repor'></span></button></a>
