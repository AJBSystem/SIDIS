...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo'])) {
		...
		} else if (empty($_POST['codigoinventario'])){
			$errors[] = "Codigo del inventario vacío";			
		...
		$codigoinventario=mysqli_real_escape_string($con,(strip_tags($_POST["codigoinventario"],ENT_QUOTES)));
		...
		$sql="INSERT INTO products (codigo_producto, serial, nombre_producto, marca_producto, modelo_producto, numero_bien, fecha, precio_producto, id_categoria, id_area, condicion_producto, id_motivo, responsable_entrega, asignacion_producto, codigo_inventario, concepto_inventario, id_rango, id_cargo) VALUES ('$codigo','$serial','$nombre','$marca','$modelo','$numero','$fecha','$precio_venta', '$id_categoria','$id_area','$condicion','$motivo','$responsable','$asignacion','$codigoinventario','$concepto','$rango','$cargo')";
