	...
	?>
	<!-- Modal -->
	<div class="modal fade" id="nuevoProductodisponible" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="responsable" name="responsable" placeholder="Responsable del producto" required maxlength="255" ></textarea>
		  ...
		  <div class="modal-footer">
			...
			<button type="submit" class="btn btn-primary" style="background:#00b3b3"  onclick = "location='disponible.php'" id="guardar_datos">Guardar datos</button>
		  </div>
		  </form>
		</div>
	  </div>
