            ...
            <div class="row">
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-12">
                      <span class="item-title"> <?php echo $row['modelo_producto'];?></span>
                    </div>

                    <div class="col-sm-12 margin-btm-10">
                      <span class="item-number"><?php echo $row['numero_bien'];?></span>
                    </div>
