  ...
  <body>
	...
	<div class="panel panel-primary">
		<div style="background:#0079a3" class="panel-heading">
		    <div class="btn-group pull-right"><a href="pdf/reporte_arbn.php">
			...
			<h4><i class='glyphicon glyphicon-search'></i> Reporte reasignación de bienes nacionales</h4>
		</div>
			...
			<form class="form-horizontal" role="form" id="datos">
				...
				<div class="row">
					 <div class='col-md-4'>
						...
						<input type="text" class="form-control" id="q" placeholder="Descripción del producto" onkeyup='load(1);'>
					</div>
